...
<div class="container">
	<form name="frmMemberInsert" class="form-horizontal" action="./addMemberAction" method="post" onsubmit="return checkForm()">
		...
		<div class="form-group  row">
			...
			<div class="col-sm-5">
				<input name="address01" type="text" class="form-control" placeholder="address01" readonly>
			</div>
		</div>
		<div class="form-group  row">
			<label class="col-sm-2 ">주소</label>
			<div class="col-sm-5">
				<input name="address02" type="text" class="form-control" placeholder="address02">
			</div>
		</div>
		<div class="form-group  row">
	...
	<script>
		document.addEventListener("DOMContentLoaded", function () {
			...
			btnIsDuplication2nd.addEventListener('click', function () {
				...
				xhr.open('GET', 'ajaxIdCheck?id=' + id);	//HTTP 요청 초기화. 통신 방식과 url 설정
			...
			// 	xhr.open('GET', 'ajaxIdCheck?id=' + id);
			// 	xhr.send();
			// 	xhr.onreadystatechange = () => {
			// 		if (xhr.readyState !== XMLHttpRequest.DONE) return;
			//

...
<!-- =============================== [content] =================================== -->
	<div>
		...
		<table border="1">
			...
			<td width="250"  align="center"><input type="password" name="ssn" maxlength="13" disabled="disabled">
			</tr>
			<tr height="50">
			...
			<td width="250"  align="center"><input type="text" name="userId" maxlength="20" disabled="disabled">
			</tr>
			<tr height="50">
